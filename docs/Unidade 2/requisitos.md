...
| US11 | Como operador, desejo realizar buscas de pedidos para facilitar a localização de orçamentos específicos.                                                                     | Os pedidos podem ser filtrados por: <ul><li>Identificador do cliente;</li><li>Etapa em curso;</li><li>Data de criação;</li></ul> Os pedidos devem mostrar os mais recentes primeiro |
...
| 11/07/2023 | 0.7    | Atualização do backlog        | Kaio Melo                                                |