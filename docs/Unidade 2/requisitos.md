...
| T02    | E03     | US04 | Como operador, desejo visualizar um gráfico que mostre o preço histórico da saca atualizado para mostrar ao cliente o valor negociado no passado                             |          12 |
| T02    | E03     | US05 | Como operador, desejo visualizar um gráfico que mostre uma projeção de lucro para a próxima colheita baseada em anos anteriores para mostrar o ganho na aquisição do produto |          12 |
| T03    | E05     | US07 | Como operador, desejo poder logar no aplicativo para relacionar as informações ao meu perfil de usuário                                                                      |          12 |
| T04    | E08     | US13 | Como operador, desejo poder visualizar o status de um pedido para saber em que etapa ele está                                                                                |          11 |
| T01    | E01     | US02 | Como operador, desejo simular cenários de financiamento para mostrar ao cliente a viabilidade do produto                                                                     |          10 |
| T02    | E03     | US06 | Como operador, desejo visualizar um indicador que mostre o lucro extra em potencial de saca por ano, para mostrar o benefício da armazenagem                                 |          10 |
| T04    | E07     | US12 | Como operador, desejo criar um pedido para acompanhar as etapas em que está: orçamento, feedback, negociação, contratação ou execução                                        |          10 |
| T04    | E04     | US20 | Como operador, desejo armazenar os dados do cliente para decisões internas.                                                                                                  |          10 |
| T04    | E07     | US21 | Como operador, desejo poder salvar o orçamento para futuras operações                                                                                                        |          10 |
| T04    | E08     | US14 | Como operador, desejo realizar buscas de pedidos para facilitar a localização de orçamentos específicos.                                                                     |           9 |
| T04    | E04     | US16 | Como operador, desejo editar pedidos já realizados para que os dados dos pedidos estejam sempre atualizados.                                                                 |           9 |
| T03    | E05     | US08 | Como administrador, desejo visualizar informações de todos os usuários para ter uma visão geral da empresa                                                                   |           8 |
| T03    | E05     | US09 | Como administrador, desejo poder criar novos usuários para que novos operadores possam utilizar o sistema                                                                    |           8 |
| T03    | E05     | US10 | Como administrador, desejo poder editar os dados de um usuário para manter os dados atualizados                                                                              |           8 |
| T03    | E05     | US11 | Como administrador, desejo poder excluir um usuário para manter o sistema organizado                                                                                         |           8 |
| T04    | E04     | US15 | Como operador, desejo remover pedidos que não estão mais em andamento.                                                                                                       |           8 |
...
| T02    | E02     | US03 | Como operador, desejo inserir um orçamento externo para calcular a viabilidade e mostrar ao cliente.                                                                         |           7 |
| T04    | E04     | US19 | Como operador, desejo poder adicionar documentos a cada etapa do pedido para manter o histórico de cada etapa                                                                |           7 |
| T04    | E08     | US22 | Como operador, desejo poder enviar o orçamento para o cliente                                                                                                                |           7 |
...
| 17/05/2023 | 0.5 | Revisando algumas hist | Lucas Pereira | 
